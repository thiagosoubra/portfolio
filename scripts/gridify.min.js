var Gridify = {
    ...
    init: function() {
        Array.prototype.forEach.call(this.gridify, function(e, t) {
            ...
            if (e.querySelectorAll(":scope > div").length != i || e.querySelectorAll(":scope > div")[0].getAttribute("class") != "column size-1of" + i) {
                for (var o = [], n = 2; n <= i; n++) {
                    var c = document.createElement("div");
                    c.setAttribute("class", "column size-1of" + i), Gridify.columns.push(c)
                }
                Array.prototype.forEach.call(e.querySelectorAll(":scope > div"), function(e, t) {
                    var r = document.createElement("div");
                    r.innerHTML = e.outerHTML.trim(), r = r.firstChild, o.push(r)
                }), e.innerHTML = "", Array.prototype.forEach.call(Gridify.columns, function(t, r) {
                    e.appendChild(t)
    ...
    destroy: function() {
        Array.prototype.forEach.call(Gridify.gridify, function(e, t) {
            if (0 != Gridify.columns.length) {
                ...
                }), Gridify.columns = [], e.innerHTML = r.innerHTML
            }
        })
    },
    reInit: function() {
    ...
    appendItem: function(e, t) {
        var r = 0;
        Array.prototype.forEach.call(Gridify.columns[0].querySelectorAll(":scope > div"), function(e, t) {
            r += e.offsetHeight
        });
        for (var i = {
                height: r,
                column: 0
            }, o = 1; o < Gridify.columns.length; o++) {
            r = 0;
            Array.prototype.forEach.call(Gridify.columns[o].querySelectorAll(":scope > div"), function(e, t) {
                r += e.offsetHeight
            }), r < i.height && (i = {
                height: r,
                column: o
